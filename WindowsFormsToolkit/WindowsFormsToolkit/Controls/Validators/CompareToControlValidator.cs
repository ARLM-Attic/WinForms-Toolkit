...
{
    /// <summary>
    /// Compare les valeurs de 2 contrôles
    /// </summary>
    [Description("Compare les valeurs de 2 contrôles")]
    public class CompareToControlValidator : BaseCompareValidator
    {
        ...
        [Description("Obtient ou défini le contrôle à comparer")]
        ...
        protected override bool EvaluateIsValid()
        {
            ...
            if (!Convert(this.controlToValidate.Text, base.Type, out obj1))
            {
                return false;
            }
            ...
            {
                object obj2;
                if (!Convert(this.controlToCompare.Text, base.Type, out obj2))
                {
                    return true;
                }
