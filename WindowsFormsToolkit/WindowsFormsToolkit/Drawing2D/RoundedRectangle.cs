...
namespace WindowsFormsToolkit.Drawing2D
{
    /// <summary>
    ...
    public struct RoundedRectangle
    {
        ...
        {
            RoundedRectangle r = RoundedRectangle.Intersect(rrect, this, this.roundedCorners, this.radius);
            this.x = r.x;
            this.y = r.y;
            this.width = r.width;
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                RoundedRectangle r = (RoundedRectangle)obj;
