...
namespace WindowsFormsToolkit.Extensions
{
    public class HotKeysManager : NativeWindow
    {
        ...
        /// <param name="e">The <see cref="WindowsFormsToolkit.Extensions.HotKeysEventArgs"/> instance containing the event data.</param>
