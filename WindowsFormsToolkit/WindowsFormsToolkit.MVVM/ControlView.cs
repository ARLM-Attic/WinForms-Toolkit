...
{
    public partial class ControlView<TViewModel> : UserControl
        where TViewModel : ViewModel
    {
        private ErrorProvider errorProvider;

        /// <summary>
        /// Initializes a new instance of the <see cref="ControlView&lt;TViewModel&gt;"/> class.
        /// </summary>
        /// <param name="viewModel">The view model.</param>
        public ControlView(TViewModel viewModel)
        {
